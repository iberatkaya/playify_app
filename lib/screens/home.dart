...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animationOffsetRight =
        Tween<Offset>(begin: Offset(0, 0), end: Offset(0.25, 0))
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color:
                      ThemeData().primaryColor, // The color should be checked!
            ...
            Column(
              ...
              children: <Widget>[
                /// Space between Top & Player
                SizedBox(
                  height: _height * spaceRatioPlayerAndTop,
                ),
                Container(
